...
class OrderItemsResponse {
    ...
    OrderItemsResponse(Order order) throws FoodDoesntExist, RestaurantDoesntExist, OrderItemDoesntExist {
        totalPrice = order.getTotalPrice();
        setItems(order);
    }

    private void setItems(Order order) throws RestaurantDoesntExist, FoodDoesntExist, OrderItemDoesntExist {
