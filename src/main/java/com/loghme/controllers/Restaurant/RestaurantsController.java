...
public class RestaurantsController {
    ...
    public RestaurantsResponse getRestaurants() {
        ...
        ArrayList<Restaurant> restaurants = RestaurantService.getInstance().getRestaurantsWithinDistance(userLocation, Configs.VISIBLE_RESTAURANTS_DISTANCE);
    ...
    public RestaurantResponse getRestaurant(@PathVariable(value = "id") String id) throws RestaurantOutOfRange, RestaurantDoesntExist {
        ...
        Restaurant restaurant = restaurantService.getRestaurantInstanceIfInRange(id, userLocation, Configs.VISIBLE_RESTAURANTS_DISTANCE);
